...
class HDRShinyBumpMapShader : public Shader {
public:
  ShProgram vsh, fsh;

  HDRShinyBumpMapShader();
  ~HDRShinyBumpMapShader();
...
HDRShinyBumpMapShader::HDRShinyBumpMapShader()
...
bool HDRShinyBumpMapShader::init()
{
  HDRImage image;
...
HDRShinyBumpMapShader HDRShinyNumpMap;
